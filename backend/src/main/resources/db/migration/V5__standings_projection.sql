...
create index if not exists idx_standings_projections_season on standings_projections (season_start_year);
create index if not exists idx_team_strength_ratings_season on team_strength_ratings (season_start_year);
create index if not exists idx_roster_change_events_team_season on roster_change_events (team_id, season_start_year);
